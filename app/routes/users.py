...
@router.get("/lawyesr/total",response_model=int, summary="Get total number of lawyers")
...
@router.get("/organizations/total",response_model=int, summary="Get total number of organizations")
